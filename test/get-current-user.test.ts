...
describe("Get current user from request request", () => {
  ...
  it("should success to get current user information", async () => {
    const response = await supertest(app)
      ...
      .set(
        "Authorization",
        "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI1NDVmMTYzYy0yM2E1LTQxNzQtOTg1NS03ZjQ4NzZjMjkzODkiLCJpYXQiOjE3MzUzNjk2NTYsImV4cCI6MTczNTM3Njg1NiwiaXNzIjoidGFza2lmeSJ9.m2HP0EAppaU6bnJCRZzMY--cDA2MHFKX5plZVPrWx34"
      )
      .send();
